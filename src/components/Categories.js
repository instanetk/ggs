        ...
        <div className="-ml-4 inline-flex">
          <div className="w-28 text-center ml-4 flex-shrink-0 px-4 py-2 pb-6">
            <div className="flex flex-col justify-center items-center ">
              ...
              />
              <span className="mt-2 w-24 font-bold leading-6 text-gray-900">Floor Installation</span>
            </div>
          </div>
          <div className="w-28 text-center ml-4 flex-shrink-0 px-4 py-2 pb-6">
            <div className="flex flex-col flex-wrap justify-center items-center ">
              ...
              />
              <span className="mt-2 w-24 font-bold leading-6 text-gray-900">Landscape & Irrigation</span>
            </div>
          </div>
          <div className="w-28 text-center ml-4 flex-shrink-0 px-4 py-2 pb-6">
            <div className="flex flex-col justify-center items-center ">
              ...
              />
              <span className="mt-2 w-24 font-bold leading-6 text-gray-900">Additions & Remodels</span>
            </div>
          </div>
          <div className="w-28 text-center ml-4 flex-shrink-0 px-4 py-2 pb-6">
            <div className="flex flex-col justify-center items-center ">
              ...
              />
              <span className="mt-2 w-24 font-bold leading-6 text-gray-900">Painting</span>
            </div>
          </div>
          <div className="w-28 text-center ml-4 flex-shrink-0 px-4 py-2 pb-6">
            <div className="flex flex-col justify-center items-center ">
              ...
              />
              <span className="mt-2 w-24 font-bold leading-6 text-gray-900">Cleaning</span>
            </div>
          </div>
          <div className="ml-4 flex-shrink-0 p-2">
            <div className="flex flex-col justify-center items-center">
              ...
              />
              <span className="mt-2 font-bold leading-6 text-gray-900">Plumbing</span>
            </div>
          </div>
        </div>
      </div>
