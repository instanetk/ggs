  ...
  return (
    <footer className="flex flex-col justify-center text-gray-100 bg-gray-800 sm:py-5 bgfloor">
      <div className="sm:flex">
        <div className="sm:w-1/2 sm:mx-14 m-4 sm:m-0 rounded-lg text-md px-4 sm:px-14 py-6 text-justify bg-gray-900 bg-opacity-70">
        ...
        <div className="sm:w-1/2  flex justify-center items-center ">
          <div className="h-24">
            ...
            <div className="text-xs text-center opacity-20 select-none justify-center self-center">
              <a href="https://davidquintero.dev" target="_blank" rel="noreferrer">
