    ...
    <div id="submenu" className={`${isOpen ? '' : 'hidden'} sm:mt-2 sm:block `}>
      <div className="w-full flex flex-nowrap justify-between px-4 py-3 bg-gray-800 sm:flex-col sm:flex-shrink-0">
        <div className="flex flex-col justify-center items-center select-none text-white hover:text-indigo-400 sm:mt-6 sm:flex-row sm:bg-transparent sm:hover:bg-gray-900 sm:rounded-md sm:justify-start sm:ml-2 sm:items-center sm:p-2">
          ...
          <span className="mt-2 text-xs uppercase opacity-80 font-bold tracking-wider content-center sm:mt-0 sm:ml-4 sm:items-center sm:text-base sm:normal-case">
            Schedule
          </span>
        </div>
        ...
        <div className="flex flex-col justify-center items-center select-none text-white hover:text-indigo-400 sm:mt-6 sm:flex-row sm:bg-transparent sm:hover:bg-gray-900 sm:rounded-md sm:justify-start sm:ml-2 sm:items-center sm:p-2">
          ...
          <span className="mt-2 text-xs uppercase opacity-80 font-bold tracking-wider content-center sm:mt-0 sm:ml-2 sm:items-center sm:text-base sm:normal-case">
            Chat
          </span>
        </div>
        <div className="flex flex-col justify-center items-center select-none text-white hover:text-indigo-400 sm:mt-6 sm:flex-row sm:bg-transparent sm:hover:bg-gray-900 sm:rounded-md sm:justify-start sm:ml-2 sm:items-center sm:p-2">
