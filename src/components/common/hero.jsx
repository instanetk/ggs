        ...
        <div className="max-w-7xl mx-auto xl:max-w-6xl">
          <div className="relative z-10 sm:bg-white sm:pb-16 md:pb-20 lg:max-w-sm lg:w-full lg:pb-8 xl:pb-15 xl:max-w-2xl">
            ...
            <main className="mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:relative lg:z-20 lg:mt-20 lg:px-8">
              <div className="sm:text-center lg:text-left xl:py-6">
                <div className="hidden sm:block mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
